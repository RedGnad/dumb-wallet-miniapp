    ...
    <div className="w-full">
      <div className="w-full">
        ...
        {series.map((s, i) => {
          ...
          return (
            <g key={s.token}>
              <path d={path} fill="none" stroke={color} strokeWidth={6} opacity={0.36} filter="url(#glow)" strokeLinecap="round" strokeLinejoin="round" style={{ mixBlendMode: 'screen' as any }}>
                <animate attributeName="opacity" values="0.34;0.4;0.34" dur="6s" repeatCount="indefinite" />
              </path>
