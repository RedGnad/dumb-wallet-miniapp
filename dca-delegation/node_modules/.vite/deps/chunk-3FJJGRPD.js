import {
  RpcSchema_exports,
  mini_exports
} from "./chunk-THKVDZTY.js";
import {
  ChainNotConfiguredError,
  ProviderNotFoundError,
  createConnector,
  extractRpcUrls
} from "./chunk-EITPT3CK.js";
import {
  withRetry,
  withTimeout
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-42R6NNXU.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-UXT2YYKV.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-3BYB7QMZ.js");
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-MUJCRID2.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
...
function porto(parameters = {}) {
  return createConnector((wagmiConfig) => {
    ...
    return {
      ...
      async getProvider() {
        porto_promise ??= (async () => {
          const { Porto } = await import("./_dist-DBY255ZB.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-AUU4TKBS.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-JRVUPSSV.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-HGPHS2FC.js");
...
*/
//# sourceMappingURL=chunk-3FJJGRPD.js.map
