...
import "./chunk-LFWLLEB6.js";
import {
  createJSONStorage,
  createStore,
  persist
} from "./chunk-YBPZ5MFB.js";
import {
  __commonJS,
  __export,
  __toESM
...
var require_u64 = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/_u64.js"(exports) {
    ...
    exports.fromBig = fromBig5;
    function split5(lst, le = false) {
      let Ah = new Uint32Array(lst.length);
      let Al = new Uint32Array(lst.length);
      for (let i = 0; i < lst.length; i++) {
        const { h: h2, l } = fromBig5(lst[i], le);
        [Ah[i], Al[i]] = [h2, l];
      }
      return [Ah, Al];
    }
    exports.split = split5;
    var toBig = (h2, l) => BigInt(h2 >>> 0) << _32n5 | BigInt(l >>> 0);
    exports.toBig = toBig;
    var shrSH5 = (h2, _l, s) => h2 >>> s;
    exports.shrSH = shrSH5;
    var shrSL5 = (h2, l, s) => h2 << 32 - s | l >>> s;
    exports.shrSL = shrSL5;
    var rotrSH5 = (h2, l, s) => h2 >>> s | l << 32 - s;
    exports.rotrSH = rotrSH5;
    var rotrSL5 = (h2, l, s) => h2 << 32 - s | l >>> s;
    exports.rotrSL = rotrSL5;
    var rotrBH5 = (h2, l, s) => h2 << 64 - s | l >>> s - 32;
    exports.rotrBH = rotrBH5;
    var rotrBL5 = (h2, l, s) => h2 >>> s - 32 | l << 64 - s;
    exports.rotrBL = rotrBL5;
    var rotr32H2 = (_h, l) => l;
    ...
    exports.add = add5;
    var add3L5 = (Al, Bl, Cl) => (Al >>> 0) + (Bl >>> 0) + (Cl >>> 0);
    exports.add3L = add3L5;
    var add3H5 = (low, Ah, Bh, Ch) => Ah + Bh + Ch + (low / 2 ** 32 | 0) | 0;
    exports.add3H = add3H5;
    var add4L5 = (Al, Bl, Cl, Dl) => (Al >>> 0) + (Bl >>> 0) + (Cl >>> 0) + (Dl >>> 0);
    exports.add4L = add4L5;
    var add4H5 = (low, Ah, Bh, Ch, Dh) => Ah + Bh + Ch + Dh + (low / 2 ** 32 | 0) | 0;
    exports.add4H = add4H5;
    var add5L5 = (Al, Bl, Cl, Dl, El) => (Al >>> 0) + (Bl >>> 0) + (Cl >>> 0) + (Dl >>> 0) + (El >>> 0);
    exports.add5L = add5L5;
    var add5H5 = (low, Ah, Bh, Ch, Dh, Eh) => Ah + Bh + Ch + Dh + Eh + (low / 2 ** 32 | 0) | 0;
    exports.add5H = add5H5;
    var u64 = {
      fromBig: fromBig5,
      split: split5,
      toBig,
...
var require_utils = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/utils.js"(exports) {
    ...
    var hexes7 = Array.from({ length: 256 }, (_2, i) => i.toString(16).padStart(2, "0"));
    ...
    function wrapConstructorWithOpts(hashCons) {
      const hashC = (msg, opts) => hashCons(opts).update(toBytes10(msg)).digest();
      const tmp = hashCons({});
      hashC.outputLen = tmp.outputLen;
      hashC.blockLen = tmp.blockLen;
...
function setBigUint64(view, byteOffset, value, isLE6) {
  ...
  const h2 = isLE6 ? 4 : 0;
  const l = isLE6 ? 0 : 4;
  view.setUint32(byteOffset + h2, wh, isLE6);
  ...
  const f = Object.freeze({
    ...
    fromBytes: (bytes2, skipValidation = true) => {
      if (allowedLengths) {
        ...
        padded.set(bytes2, isLE6 ? 0 : padded.length - bytes2.length);
        bytes2 = padded;
      }
      if (bytes2.length !== BYTES)
        throw new Error("Field.fromBytes: expected " + BYTES + " bytes, got " + bytes2.length);
      let scalar = isLE6 ? bytesToNumberLE(bytes2) : bytesToNumberBE(bytes2);
      if (modFromBytes)
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/crypto.js
var crypto4 = typeof globalThis === "object" && "crypto" in globalThis ? globalThis.crypto : void 0;

// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/utils.js
function isBytes3(a) {
  return a instanceof Uint8Array || ArrayBuffer.isView(a) && a.constructor.name === "Uint8Array";
}
function anumber3(n) {
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/hmac.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/_md.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/legacy.js
...
var K2 = Array.from({ length: 64 }, (_2, i) => Math.floor(p322 * Math.abs(Math.sin(i + 1))));
...
var Id1602 = (() => Uint8Array.from(new Array(16).fill(0).map((_2, i) => i)))();
...
function ripemd_f2(group, x, y2, z) {
  if (group === 0)
    return x ^ y2 ^ z;
  if (group === 1)
    return x & y2 | ~x & z;
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/_u64.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/sha2.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip32/lib/esm/index.js
var Point = secp256k1.ProjectivePoint;
var base58check = createBase58check(sha2565);
var MASTER_SECRET = utf8ToBytes3("Bitcoin seed");

// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/crypto.js
var crypto5 = typeof globalThis === "object" && "crypto" in globalThis ? globalThis.crypto : void 0;

// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/utils.js
function isBytes4(a) {
  return a instanceof Uint8Array || ArrayBuffer.isView(a) && a.constructor.name === "Uint8Array";
}
function anumber4(n) {
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/hmac.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/_md.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/_u64.js
...
function split4(lst, le = false) {
  ...
  let Al = new Uint32Array(len);
  for (let i = 0; i < len; i++) {
    const { h: h2, l } = fromBig4(lst[i], le);
    [Ah[i], Al[i]] = [h2, l];
  }
  return [Ah, Al];
}
var shrSH4 = (h2, _l, s) => h2 >>> s;
var shrSL4 = (h2, l, s) => h2 << 32 - s | l >>> s;
var rotrSH4 = (h2, l, s) => h2 >>> s | l << 32 - s;
var rotrSL4 = (h2, l, s) => h2 << 32 - s | l >>> s;
var rotrBH4 = (h2, l, s) => h2 << 64 - s | l >>> s - 32;
var rotrBL4 = (h2, l, s) => h2 >>> s - 32 | l << 64 - s;
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/sha2.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/wordlists/czech.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/wordlists/english.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/wordlists/french.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/wordlists/italian.js
var wordlist4 = `abaco
abbaglio
abbinato
abete
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/wordlists/japanese.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/wordlists/korean.js
var wordlist6 = `가격
가끔
가난
가능
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/wordlists/portuguese.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/wordlists/simplified-chinese.js
var wordlist8 = `的
一
是
在
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/wordlists/spanish.js
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/wordlists/traditional-chinese.js
var wordlist10 = `的
一
是
在
...
var hexes6 = Array.from({ length: 256 }, (_2, i) => i.toString(16).padStart(2, "0"));
...
var HashMD5 = class extends Hash5 {
  constructor(blockLen, outputLen, padOffset, isLE6) {
    super();
    this.blockLen = blockLen;
    this.outputLen = outputLen;
...
var SHA256_IV5 = new Uint32Array([
  1779033703,
  3144134277,
  1013904242,
  2773480762,
...
var SHA2565 = class extends HashMD5 {
  constructor() {
    super(64, 32, 8, false);
...
var sha2567 = wrapConstructor(() => new SHA2565());
var sha2245 = wrapConstructor(() => new SHA2245());
...
*/
//# sourceMappingURL=dist-UXT2YYKV.js.map
